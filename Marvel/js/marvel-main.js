...
function marvel_choose_char() {
   var hero_id = document.getElementsByClassName('swiper-slide-active')[0].getAttribute('id');
   var hero_card = document.getElementsByClassName('swiper-slide-active')[0];
...
function load_marvel_images() {
   ...
   marvel_queue.loadManifest([
      "./images/cards/Arryn.svg",
      "./images/cards/Greyjoy.svg",
      "./images/cards/Lannister.svg",
      "./images/cards/Mormont.svg"
   ]);

   function marvel_handleComplete() {
      document.getElementById('marvel-loading-content').style.display = 'none';
      start_marvel_section();
